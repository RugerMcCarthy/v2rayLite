 ...
 */
object AppConfig {
    const val ANG_PACKAGE = "com.thoughtcrime.v2raylite"
    const val ANG_PACKAGE_LOG = "com.v2raylite"
    // legacy
...
//        const val PREF_TG_GROUP = "pref_tg_group"
    ...
    const val BROADCAST_ACTION_SERVICE = "com.thoughtcrime.v2raylite.action.service"
    const val BROADCAST_ACTION_ACTIVITY = "com.thoughtcrime.v2raylite.action.activity"
    const val BROADCAST_ACTION_WIDGET_CLICK = "com.thoughtcrime.v2raylite.action.widget.click"
